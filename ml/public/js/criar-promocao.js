...
const JobsWatcher = (function () {
  ...
  async function poll() {
    try {
      const r = await fetch("/ml/api/promocoes/jobs", {
        credentials: "same-origin",
        cache: "no-store",
...
async function removerEmMassaSelecionados() {
  ...
  try {
    const r = await fetch("/ml/api/promocoes/jobs/remove", {
      method: "POST",
...
async function aplicarTodosFiltrados() {
  ...
  try {
    ...
    const prepRes = await fetch("/ml/api/promocoes/selection/prepare", {
      method: "POST",
      headers: { "Content-Type": "application/json" },
      credentials: "same-origin",
...
async function atualizarFaixaSelecaoCampanha() {
  try {
    ...
    const r = await fetch("/ml/api/promocoes/selection/prepare", {
      method: "POST",
      headers: { "Content-Type": "application/json" },
      credentials: "same-origin",
